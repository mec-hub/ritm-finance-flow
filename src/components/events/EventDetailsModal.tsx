...
import { Edit, Clock, User, MapPin, DollarSign, Calculator, ChevronLeft, ChevronRight } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            {hasMultipleEvents && (
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" onClick={goToPrevious} className="text-gray-400 hover:text-white hover:bg-gray-800">
                  <ChevronLeft className="h-4 w-4" />
                </Button>
                <span className="text-sm text-gray-400">
                  {currentEventIndex + 1} de {sortedEvents.length}
                </span>
                <Button variant="ghost" size="sm" onClick={goToNext} className="text-gray-400 hover:text-white hover:bg-gray-800">
        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#343434' }}>
                ...
                <p className="font-medium">
                  {currentEvent.startTime && currentEvent.endTime
                    ...
                    : currentEvent.startTime
                      ? `A partir das ${formatTime(currentEvent.startTime)}`
                      : currentEvent.endTime
                        ? `Até às ${formatTime(currentEvent.endTime)}`
                        : 'Não definido'}
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={cn("font-medium", (currentEvent.estimatedRevenue - currentEvent.estimatedExpenses) >= 0 ? "text-blue-400" : "text-red-400")}>
          ...
          <div className="flex justify-between items-center pt-4 border-t border-[#191919]">
            ...
            <Button onClick={handleEdit} className="bg-yellow-500 hover:bg-yellow-600 text-black font-medium">
